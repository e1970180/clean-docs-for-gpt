...
trigger_variables:
  ...
  keys:
    PARAMETER_NAME:
      description: "The value of the variable. Any YAML is valid. Only limited templates can be used."
      type: any
mode:
...
- id: my_unique_id  #  **Devices & services** > **Entities**" %} and find the automation in the search field or by scrolling down.
