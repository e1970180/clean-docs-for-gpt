  ...
  keys:
    ...
    domain:
      description: >
        ...
        for example, `light` or
        `binary_sensor`. Can be either a string
...
type:
  description: >
    The type of input. This supplies the HTML `type` attribute,
...
autocomplete:
  description: >
    ...
    This supplies the HTML `autocomplete` attribute.
